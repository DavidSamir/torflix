...
private const val ENCRYPTED_FILE = "myflix_secure"
private const val PLAIN_FALLBACK_FILE = "myflix_secure_fallback"
...
class SecureTokenStore @Inject constructor(
    ...
    var token: String?
        ...
        set(value) {
            ...
            }.onFailure { MyflixLog.e(TAG, "Failed to persist API token", it) }
        }
    ...
    private fun createPreferences(): SharedPreferences = try {
        ...
        MyflixLog.e(TAG, "Encrypted storage unavailable; falling back to plain preferences", error)
