...
import com.myflix.core.data.database.ProgressEntity
...
class ProgressRepository @Inject constructor(
    ...
    suspend fun save(
        ...
        runCatching { progressDao.upsert(entity) }
            .onFailure { MyflixLog.e(TAG, "Failed to persist progress for $itemId", it) }
    ...
    suspend fun pushPending(): Boolean {
        ...
        for (entity in pending) {
            ...
            if (result.isSuccess) {
                ...
                allOk = false
                MyflixLog.w(TAG, "Progress sync failed for ${entity.itemId}", result.exceptionOrNull())
