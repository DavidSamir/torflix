...
import com.torfilx.core.testing.FakeMediaRemoteSource
import com.torfilx.core.testing.FakeTimeProvider
import com.torfilx.core.testing.Fixtures
...
class ProgressRepositoryTest {
    ...
    fun `pushing pending marks rows synced and reports failures for retry`() = runTest {
        ...
        remote.failure = { com.torfilx.core.common.error.DataError.ServerUnreachable("offline") }
