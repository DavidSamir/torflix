...
private val MyflixColorScheme = darkColorScheme(
    ...
    onPrimary = MyflixColors.TextOnAccent,
    secondary = MyflixColors.SurfaceHigh,
    onSecondary = MyflixColors.TextPrimary,
    background = MyflixColors.Background,
    onBackground = MyflixColors.TextPrimary,
    surface = MyflixColors.Surface,
    onSurface = MyflixColors.TextPrimary,
    surfaceVariant = MyflixColors.SurfaceHigh,
    onSurfaceVariant = MyflixColors.TextSecondary,
    error = MyflixColors.Error,
    border = MyflixColors.Focus,
)
...
val LocalMyflixDimens = staticCompositionLocalOf { MyflixDimens() }
