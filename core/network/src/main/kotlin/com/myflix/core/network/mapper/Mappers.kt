package com.myflix.core.network.mapper
...
import com.myflix.core.network.dto.AudioTrackDto
import com.myflix.core.network.dto.CapabilitiesDto
import com.myflix.core.network.dto.EpisodeDto
import com.myflix.core.network.dto.HomeRowDto
import com.myflix.core.network.dto.MarkersDto
import com.myflix.core.network.dto.MediaItemDto
import com.myflix.core.network.dto.MediaSourceDto
import com.myflix.core.network.dto.PlaybackInfoDto
import com.myflix.core.network.dto.ProgressDto
import com.myflix.core.network.dto.SeasonDto
import com.myflix.core.network.dto.ServerInfoDto
import com.myflix.core.network.dto.SpriteSheetDto
import com.myflix.core.network.dto.SubtitleDto
import com.myflix.core.network.dto.VideoDecoderDto
...
fun <T, R> mapItemsSkippingBad(items: List<T>, transform: (T) -> R): List<R> =
    items.mapNotNull { item ->
        try {
            ...
            MyflixLog.w(MAPPER_TAG, "Skipping malformed item: ${error.message}")
            null
        } catch (error: NullPointerException) {
            MyflixLog.w(MAPPER_TAG, "Skipping item with missing required field: ${error.message}")
            null
        }
    }
