package com.torfilx.core.network.di
...
object NetworkModule {
    ...
    private const val PLACEHOLDER_BASE_URL = "http://torfilx.invalid/"
    ...
    @Provides
    @Singleton
    fun providesApiService(retrofit: Retrofit): TorfilxApiService =
        retrofit.create(TorfilxApiService::class.java)
}
