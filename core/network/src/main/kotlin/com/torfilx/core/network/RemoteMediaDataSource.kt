...
import com.torfilx.core.network.api.ApiResult
import com.torfilx.core.network.api.TorfilxApiService
import com.torfilx.core.network.api.apiCall
import com.torfilx.core.network.api.apiCallBody
import com.torfilx.core.network.dto.CapabilitiesDto
import com.torfilx.core.network.dto.ProgressUpdateDto
import com.torfilx.core.network.mapper.mapItemsSkippingBad
import com.torfilx.core.network.mapper.toDomain
import com.torfilx.core.network.mapper.toDto
import com.torfilx.core.network.mapper.toIsoUtc
...
class RemoteMediaDataSource @Inject constructor(
    private val api: TorfilxApiService,
    ...
    suspend fun libraryItems(
        ...
        page: Int = 0,
        pageSize: Int = TorfilxApiService.PAGE_SIZE,
        sinceMs: Long? = null,
        etag: String? = null,
    ): LibraryPage? {
    ...
    suspend fun search(query: String, limit: Int = TorfilxApiService.SEARCH_LIMIT): List<SearchResult> =
