package com.myflix.core.player.capability
...
import com.myflix.core.model.VideoDecoderCapability
import com.myflix.core.model.VideoMimeTypes
...
class DeviceCapabilitiesProvider @Inject constructor(
    ...
    private fun compute(): DeviceCapabilities = try {
        ...
        MyflixLog.e(TAG, "Capability detection failed; using conservative defaults", error)
    ...
    private fun videoDecoders(): List<VideoDecoderCapability> {
        ...
        MyflixLog.i(TAG, "Video decoders: ${result.keys.joinToString()}")
    ...
    private fun passthroughCodecs(): Set<String> {
        ...
        }.onFailure { MyflixLog.w(TAG, "Passthrough detection failed", it) }
        return result
    }
    ...
    private fun displayInfo(): DisplayInfo {
        ...
        }.onFailure { MyflixLog.w(TAG, "HDR capability query failed", it) }
