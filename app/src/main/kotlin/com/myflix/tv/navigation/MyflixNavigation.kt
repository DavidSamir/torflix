package com.myflix.tv.navigation
...
import com.myflix.feature.details.DetailsScreen
import com.myflix.feature.details.DetailsViewModel
import com.myflix.feature.home.HomeScreen
import com.myflix.feature.library.LibraryMode
import com.myflix.feature.library.LibraryScreen
import com.myflix.feature.player.PlayerScreen
import com.myflix.feature.player.PlayerViewModel
import com.myflix.feature.search.SearchScreen
import com.myflix.feature.settings.SettingsScreen
...
object Routes {
    ...
    fun player(playableId: String, showId: String?, startPositionMs: Long?) = buildString {
        append("player/")
        append(playableId)
        append("?showId=")
